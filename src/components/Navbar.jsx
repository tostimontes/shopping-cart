...
export default function Navbar() {
  ...
  return (
    <>
      <nav
        className={`${showNavbar ? 'top-0' : '-top-16'} transition-top sticky top-0 z-20 flex h-16 w-full items-center justify-around bg-orange-700 p-4 text-yellow-100 duration-300 ease-in-out`}
      >
